...
JNIEXPORT jobject JNICALL Java_com_pramit_rhm_ui_GraphicsUtils_blur(JNIEnv *env, jclass thisClass, jobject backgroundBitmap, jint radius)
{
...
JNIEXPORT jobject JNICALL Java_com_pramit_rhm_ui_GraphicsUtils_merge(JNIEnv *env, jclass thisClass, jobject backgroundBitmap, jobject componentBitmap, jint xOffset, jint yOffset)
{
    jclass java_bitmap_class = (jclass)(*env)->FindClass(env, "android/graphics/Bitmap");
